            ...
            <li key={item.title}>
              <Link href={item.href}>
                <a
                  className={
                    asPath === item.href
                      ? 'flex items-center p-2 text-sm font-normal text-gray-900 border-l-4 border-indigo-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'
                      : 'flex items-center p-2 text-sm font-normal text-gray-900 hover:border-l-4 hover:border-indigo-600 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700'
                  }>
